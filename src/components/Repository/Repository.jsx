...
const Repository = ({repo}) => {
    ...
    return (
        <div className="component-container">
            ...
            <div className="one-liner">{repo.description}</div>
            <div className="minor-details">
                {
                    ...
                    <div className="license">
                        ...
                        <div className="text">{repo.license}</div>
                    </div>
                }
                <div className="forks">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text">{repo.forks}</div>
                </div>
                <div className="stars">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text">{repo.stargazers_count}</div>
                </div>
                <div className="updated">{repo.updated_at}</div>
            </div>
        </div>
    )
}
